...
<head>
	...
	<script>
		$(document).ready(function(){
			$("#more").click(function(){
				$("#test").after("<ul><li><a id=\"lol\" href=\"questionBank.php?subject=test&chapter=test\" >Only test</a></li></ul>");
				$("#more").hide();
			});
			$("#more1").click(function(){
				$("#test1").after("<ul><li><a id=\"lol\" href=\"questionBank.php?subject=test&chapter=test\" >Only test</a></li></ul>");
				$("#more1").hide();
			});
			$("#more2").click(function(){
				$("#test2").after("<ul><li><a id=\"lol\" href=\"questionBank.php?subject=test&chapter=test\" >Only test</a></li></ul>");
				$("#more2").hide();
			});
			$("#more3").click(function(){
				$("#test3").after("<ul><li><a id=\"lol\" href=\"questionBank.php?subject=test&chapter=test\" >Only test</a></li></ul>");
				$("#more3").hide();
			});
...
<body>
	...
	<div class="container-fluid">
		...
		<div>
			<a id="test" href="questionBank.php?subject=test&chapter=all" >All chapters</a> <a href="#" id="more">Expand</a>
		</div>
		
		<div>
			<a id="test1" href="questionBank.php?subject=test&chapter=all" >All chapters</a> <button id="more1">+</button>
		</div>
		
		<div>
			<a id="test2" href="questionBank.php?subject=test&chapter=all" >All chapters</a> <button id="more2">+</button>
		</div>
		<div>
			<a id="test3" href="questionBank.php?subject=test&chapter=all" >All chapters</a> <button id="more3">+</button>
		</div>
