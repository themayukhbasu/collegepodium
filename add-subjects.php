...
<head>
	...
	<script>
		$(document).ready(function() {
			...
			$('#more').click(function() {
				if (count >= 10) return;
				$('#subj').append('<br/><br/><span><label>Subject :</label></span><select name="university' + count + '" id="dat" class="dat"> </select>');
				$.ajaxCallSubj(0,1);
				count++;
				if (count > 9) {
					$('#more').empty();
						...
						<div class="col-lg-12">
							<div id="upload-form-wrap" class="col-md-10">
								...
								<div class="upload-form">
									<form action="updUserSubj.php" method="POST" enctype="multipart/form-data" id="uploadimage"> 
										<h1>Add Subject</h1>
										<div id="upload-form-main" class="page-content">			
											<div class="form-group">
												<div id="subj">
												<span><label>Subject : </span></label> 
													<select name="university0" id="dat" class="dat">
														<!--Fill with JS-->
													</select>
												</div>
												<div>
													<span><a id="more">Add more</a></span>
												</div>
												<div>
