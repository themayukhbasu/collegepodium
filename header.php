...
<head>
	...
	<?php
	/* Session Verification and Token Verification */
	require 'session.php';
	...
	<!--  Initial Page Title -->
	<title>College Podium - Free Platform to Share, Collaborate for College Students</title>

	<!-- Style Sheets - CSS -->
	<link rel="stylesheet" type="text/css" href="Style/index_post_display.css" >
	<link rel="stylesheet" type="text/css" href="Style/common.css">
	<link rel="stylesheet" type="text/css" href="Style/sidebar.css">
	<link rel="stylesheet" href="Style/pace.css">

	<!-- Style Sheets - Libraries -->
	<link rel="stylesheet" type="text/css" href="bs/css/bootstrap.min.css">
	<link rel="stylesheet" type="text/css" href="bs/css/bootstrap-theme.min.css">

	<!-- Script Files - Libraries -->
	...
	<div class="container-fluid">
				...
				<div class="col-sm-2 col-md-2">
					<div class="dropdown">
					  ...
					  <ul class="dropdown-menu dropdown-menu-left" role="menu" aria-labelledby="dropdownMenu1">
						...
						<hr class="row">
						<li role="presentation"><a role="menuitem" tabindex="-1" id="settings-logout" href="#">
							<span class="glyph glyphicon glyphicon-off" aria-hidden="true"></span> Logout
						</a></li>
					  </ul>
					</div>
				</div>	
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                <li>
                    <a href="upload_notes.php">upload notes<span class="glyphicon glyphicon-circle-arrow-up"></span></a>
                </li>
                <li>
                    <a href="static_upload.php?type=notice">post a notice<span class="glyphicon glyphicon-edit"></span></a>
                </li>
                <li>
                    <a href="static_upload.php?type=query">
                    	 post a query<span class="glyphicon glyphicon-question-sign"></span>
                    </a>
                </li>
                <li>
                    <a href="static_upload.php?type=discuss">start a discussion<span class="glyphicon glyphicon-list-alt"></span></a>
                </li>

				<hr class="divider" />
				
				<li>
                    <a href="index.php">all posts<span class="glyphicon glyphicon-th-list"></span></a>
                </li>
				
				<li>
                    <a href="notes.php">all notes<span class="glyphicon glyphicon-collapse-up"></span></a>
                </li>
				
				<hr class="divider" />
				
				<li>
                    <a href="#" id="logout" class="sidebar-logout">
        ...
        <a href="#" id="left-menu-tgl" class="left-menu">
