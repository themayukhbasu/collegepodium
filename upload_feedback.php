                ...
                <div class="row">
                    <div class="col-lg-12">
						<div id="upload-form-wrap" class="col-md-10">
							...
							<form action="api-feedback.php" method="POST" enctype="multipart/form-data" id="uploadimage"> 
								<h1>provide feedback</h1>
								<div id="upload-form-main" class="page-content">			
									<div class="form-group">
										<span class="same-line"><label>Title</label></span> 
										<input type="text" name="fb_title"  class="same-line" maxlength="2000" required></input>
									</div class="form-group">
									
									<div>
										<span class="same-line"><label class="text-top">Description and comments:</label></span> 
										<textarea name="fb_content" class="same-line" required></textarea>
									
									</div>

									<div class="form-group">
										<span><label>Screenshot / Picture</span></label>
										<span class="upload-sign" id="upload-button"><span class="glyphicon glyphicon-cloud-upload" aria-hidden="true"></span></span>
										<span id="upload-wrap"><input type="file" name="file" value="Upload" id="upload_inp"></span>
									</div>
									
									<div class="form-group">	
										<span><label>Component</span></label> 
											<select name="fb_comp">
												<option value="notes-display" name="fb_comp">Notes Display</option>
												<option value="posts-display" name="fb_comp">Main posts display</option>
												<option value="posts-comment" name="fb_comp">Post commenting / individual post page</option>
												<option value="post-upload" name="fb_comp">Notice / Discussion / Query upload</option>
												<option value="notes-other" name="fb_comp">Anything else related to notes</option>
												<option value="posts-other" name="fb_comp">Anything else related to posts</option>
												<option value="others" name="fb_comp">Other</option>
											</select>
									</div>
