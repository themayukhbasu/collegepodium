			<h2>Welcome to College Podium!</h2>
			<p>These terms and conditions outline the rules and regulations for the use of  College Podium's Website. <br />
				<span style="text-transform: capitalize;">College Podium</span> is located at:<br />
				<address>
					29 C Mahim Halder Street , <br />
					Kolkata, West Bengal 701026<br />
					India<br />
				</address>
				By accessing this website we assume you accept these terms and conditions in full. Do not continue to use College Podium's website if you do not accept all of the terms and conditions stated on this page.
			</p>
			...
			<h2>Cookies</h2>
			<p>We employ the use of cookies. By using <a title="College Podium" href="http://www.collegepodium.com">College Podium</a>'s website you consent to the use of cookies in accordance with College Podium’s privacy policy.</p>
			...
			<h2>License</h2>
			<p>Unless otherwise stated, College Podium and/or it’s licensors own the intellectual property rights for all material on College Podium All intellectual property rights are reserved. You may view and/or print pages from http://www.collegepodium.com for your own personal use subject to restrictions set in these terms and conditions.</p>
			<p>You must not:</p>
			<ul>
				<li>Republish material from http://www.collegepodium.com</li>
				<li>Sell, rent or sub-license material from http://www.collegepodium.com</li>
				<li>Reproduce, duplicate or copy material from http://www.collegepodium.com</li>
			</ul>
			<p>Redistribute content from College Podium (unless content is specifically made for redistribution).</p>

			<h3>User Comments</h3>
			<ol>
				<li>This Agreement shall begin on the date hereof.</li>
				<li>Certain parts of this website offer the opportunity for users to post and exchange opinions, information, material and data ('Comments') in areas of the website. College Podium does not screen, edit, publish or review Comments prior to their appearance on the website and Comments do not reflect the views or opinions of College Podium, its agents or affiliates. Comments reflect the view and opinion of the person who posts such view or opinion. To the extent permitted by applicable laws College Podium shall not be responsible or liable for the Comments or for any loss cost, liability, damages or expenses caused and or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.</li>
				<li>College Podium reserves the right to monitor all Comments and to remove any Comments which it considers in its absolute discretion to be inappropriate, offensive or otherwise in breach of these Terms and Conditions.</li>
				...
				<li>You hereby grant to <strong>College Podium</strong> a non-exclusive royalty-free license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</li>
			</ol>
			...
			<p>If you are among the organizations listed in paragraph 2 above and are interested in linking to our website, you must notify us by sending an e-mail to <a href="mailto:mail@collegepodium.com" title="send an email to mail@collegepodium.com">mail@collegepodium.com</a>. Please include your name, your organization name, contact information (such as a phone number and/or e-mail address) as well as the URL of your site, a list of any URLs from which you intend to link to our Web site, and a list of the URL(s) on our site to which you would like to link. Allow 2-3 weeks for a response.</p>
